    ...
    <div style={{ minHeight: '100vh', background: '#0d1117', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#1a2035', border: '1px solid #2d3748', borderRadius: 12, padding: 40, width: 360 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ color: '#f9fafb', fontSize: 20, fontWeight: 700, margin: '8px 0 4px' }}>Ruff Liners</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@ruffliners.com" required
